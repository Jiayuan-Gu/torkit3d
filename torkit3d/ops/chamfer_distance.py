...
class ChamferDistanceFunction(torch.autograd.Function):
    ...
    def forward(ctx, xyz1, xyz2):
        ...
        dist1, idx1, dist2, idx2 = _C.chamfer_distance_forward_cuda(xyz1, xyz2)
    ...
    def backward(ctx, grad_dist1, grad_dist2):
        ...
        grad_xyz1, grad_xyz2 = _C.chamfer_distance_backward_cuda(
...
def nn_distance(xyz1, xyz2, transpose=False):
    ...
    return _C.chamfer_distance_forward_cuda(xyz1, xyz2)
